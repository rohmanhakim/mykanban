...
class Note extends React.Component {
  ...
  renderEdit = () => {
    // We deal with blur and input handler here. These map to DOM events.
    // We also set selection to input end using a callback at ref
    // It gets triggered after the component is mounted
    //
    // We coud also use a string reference (i.e., `ref="input") and
